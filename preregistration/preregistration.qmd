...
A third lexical variable, the diversity of vocabulary within a text, modulates reading difficulty in ways that depend on the reader's own vocabulary knowledge [@vandenboschRoleLinguisticDiversity2019a; @cainReadingComprehensionVocabulary2014]. For skilled adults, moderate lexical diversity may sustain engagement through varied and precise word choice; for less proficient readers, including children, high diversity can overwhelm decoding resources and impair comprehension. Lexical diversity is typically operationalised through indices such as the type/token ratio (TTR) or the Measure of Textual Lexical Diversity (MTLD) [@fredrickLexicalDiversitySyntactic2025]. 
...
Taken together, this body of research establishes that reading comprehension is jointly shaped by a constellation of text-level variables operating across multiple linguistic levels [@nationChildrensReadingDifficulties2019; @duffEstimatesIndividualDifferences2020a]. These variables predict reading behaviour — including reading time, fixation patterns and comprehension accuracy — in both children and adults, though with developmental differences in magnitude and direction. The present study builds on this tradition by incorporating these established predictors as fixed effects in our analytic models (see Analytic Plan), while also examining how they interact with child age as a proxy for developing linguistic and cognitive capacity. We turn next to a more recent line of work that complements these feature-based approaches with neural language models.
